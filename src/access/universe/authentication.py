...
class AccessUniverseAuthentication(BaseAccessAuthentication):
    ...
    def __init__(self, session_scope: str, account_mobile_country_code: str, account_mobile_number: str):
        ...
        super(AccessUniverseAuthentication, self).__init__(session_scope=session_scope, validity_in_minutes=10)
