...
"""Model architecture/optimization options for eapp-cog-retriever document reader."""
...
def add_model_args(parser):
    ...
    # Model architecture
    model = parser.add_argument_group('eapp-cog-retriever Reader Model Architecture')
    ...
    detail = parser.add_argument_group('eapp-cog-retriever Reader Model Details')
    ...
    optim = parser.add_argument_group('eapp-cog-retriever Reader Optimization')
