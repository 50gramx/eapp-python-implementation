...
from community.gramx.fifty.zero.ethos.identity.models.base_models import Base
...
target_metadata = [Base.metadata, AccountAssistantConnections.metadata, AccountConnections.metadata]
