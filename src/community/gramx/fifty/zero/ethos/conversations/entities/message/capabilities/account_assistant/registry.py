...
from community.gramx.fifty.zero.ethos.conversations.entities.message.capabilities.account_assistant.capabilities.send_account_assistant_message_service import \
    SendAccountAssistantMessageService
from support.application.registry import Registry


def register_account_assistant_message_services(aio: bool):
    if aio:
        pass
    else:
